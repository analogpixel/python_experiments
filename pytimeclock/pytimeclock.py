...
def read_todo():
    ...
    a = a + ['rabbit hole:','journal','sketchbook','quit','sleep', 'interupt', 'chat','browsing', 'unscheduled','walk','exercise','read', 'meditate', 'Listen Music','Daily Pages', 'Planning', 'Khan', 'cooking']
    fzf = FzfPrompt()
